            ...
            <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                ...
                <select 
                    ...
                    defaultValue=""
                >
                    <option disabled selected value="">Selecione o game que deseja</option>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-2 flex-1">
                  <label htmlFor="hourStart">Qual horário do seu dia?</label>
              ...
              <footer className="mt-4 flex justify-end gap-4">
                ...
                <button className="bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3" type="submit">
                  <GameController />
                  Encontrar duo
                </button>
              </footer>
